import { EncryptedKey } from "../../src/walletSdk/Types";
import {
  decrypt,
  encrypt,
  NONCE_BYTES,
} from "../../src/walletSdk/KeyManager/helpers/scryptEncryption";
import { getKeyMetadata } from "../../src/walletSdk/KeyManager/helpers/getKeyMetadata";

describe("scryptEncryption", () => {
