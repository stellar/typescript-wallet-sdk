 ...
 * @param {ScryptPassParams} params - The scrypt pass params.
 * @param {string} params.password plaintext password from user
 * @param {string} params.salt salt (should be randomly generated)
 ...
 * @returns {Promise<EncryptResponse>} the encrypt response
 */
