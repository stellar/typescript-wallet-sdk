...
* `getInvocationArgs` returns `undefined` for an unrecognised executable or authorized-function type instead of throwing, and `getInvocationDetails` omits that entry from its list rather than crashing
